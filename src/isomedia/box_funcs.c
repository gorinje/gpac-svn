...
void gf_isom_box_del(GF_Box *a)
{
	...
	case GF_ISOM_BOX_TYPE_CTIM: boxstring_del(a); return;
	case GF_ISOM_BOX_TYPE_IDEN: boxstring_del(a); return;
...
GF_Err gf_isom_box_read(GF_Box *a, GF_BitStream *bs)
{
	...
	case GF_ISOM_BOX_TYPE_CTIM: return boxstring_Read(a, bs);
	case GF_ISOM_BOX_TYPE_IDEN: return boxstring_Read(a, bs);
...
GF_Err gf_isom_box_write_listing(GF_Box *a, GF_BitStream *bs)
{
	...
	case GF_ISOM_BOX_TYPE_CTIM: return boxstring_Write(a, bs);
	case GF_ISOM_BOX_TYPE_IDEN: return boxstring_Write(a, bs);
...
static GF_Err gf_isom_box_size_listing(GF_Box *a)
{
	...
	case GF_ISOM_BOX_TYPE_CTIM: return boxstring_Size(a);
	case GF_ISOM_BOX_TYPE_IDEN: return boxstring_Size(a);
